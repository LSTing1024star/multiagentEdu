...
CREATE TABLE IF NOT EXISTS assistment_raw (
    ...
    data_subject VARCHAR(20) DEFAULT "math",
    ...
    UNIQUE KEY unique_record (user_id, problem_id, data_subject)  -- 避免重复数据
);
...
CREATE TABLE IF NOT EXISTS student_problem (
    ...
    problem_subject VARCHAR(20) DEFAULT "math",
...
CREATE TABLE IF NOT EXISTS student_skills (
    ...
    skill_name VARCHAR(100) NOT NULL,  -- 知识点名称
    skill_subject VARCHAR(20) DEFAULT "math",
...
CREATE TABLE IF NOT EXISTS learning_resources (
    ...
    source_subject VARCHAR(20) DEFAULT "math",
    error_rate FLOAT NOT NULL,  -- 错误率
    difficulty_level INT NOT NULL,  -- 难度等级（1-5）
    source_type VARCHAR(10),  -- 资源格式（video/text）
...
CREATE TABLE IF NOT EXISTS student_agent_record (
    ...
    stu_subject VARCHAR(20) DEFAULT "math",
    ...
    states VARCHAR(20) DEFAULT 'completed',  -- 交互状态（completed=完成，interrupted=中断）
    -- 外键关联（确保学生存在）
